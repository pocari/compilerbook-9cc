...
assert 5 'int main() {int a; int b;int c;int d; a = 4; b = 5; c = 6; d = &a + 8; return *d; }'
assert 5 'int main() {int a; int b; int c; int d; a = 4; b = 5; c = 6; d = &c - 8; return *d; }'
assert 12 'int main() {int a; int b; int c; a = 4; b = 5; c = 6; *(&c - 8) = 12; return b; }'
